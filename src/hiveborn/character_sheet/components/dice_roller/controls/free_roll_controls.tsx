    ...
    return (
        <div className="mb-4 grid gap-3 sm:grid-cols-2">
            <label className="grid gap-1 text-sm font-semibold">
                Dice
                <div className="grid h-10 grid-cols-[2.5rem_1fr_2.5rem] overflow-hidden rounded-md border border-input bg-background/70 text-foreground shadow-xs">
                    <button
                        type="button"
                        className="flex h-full items-center justify-center border-r border-primary/20 bg-primary text-primary-foreground transition-colors duration-150 hover:bg-primary/85 disabled:cursor-not-allowed disabled:bg-primary/35 disabled:text-primary-foreground/45"
                    ...
                    <button
                        type="button"
                        className="flex h-full items-center justify-center border-l border-primary/20 bg-primary text-primary-foreground transition-colors duration-150 hover:bg-primary/85 disabled:cursor-not-allowed disabled:bg-primary/35 disabled:text-primary-foreground/45"
